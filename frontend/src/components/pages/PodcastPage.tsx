...
export const PodcastPage = () => {
  ...
  return (
    <div className="relative flex justify-center gap-24 items-center h-full">
      <div className="absolute inset-0 bg-gradient-to-bl dark:from-[#111827] dark:to-spotify-green/60 dark:via-[#111827] from-white via-white via-60% to-spotify-green/60 animate-gradient-x" />
