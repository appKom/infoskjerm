...
export const BlastCard = ({ blast }: { blast: BlastType }) => {
  return (
    <div
      className={`relative flex flex-col justify-center overflow-hidden bg-white border border-gray-200 shadow rounded-xl dark:bg-gray-800 dark:border-gray-700 w-[1100px]`}
      key={2}
    >
